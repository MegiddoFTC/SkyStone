...
//@Disabled
@Autonomous(name = "JackRedGlow")
public class JackRedGlow extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        EncodersControl(0.4, 1000, 1000, 1000, 1000, -1, -1, 0, 0);
        EncodersControl(1, -1200, -1200, -1200, -1200, -1, -1, 0, 0);
        Griper.setPosition(0);
        EncodersControl(1, 3400, -3400, -3400, 3400, -1, -1, 0, 0);
        EncodersControl(1, 1800, -1800, 1800, -1800, 0, 0, 800, 800);
        EncodersControl(0.3, -800, -800, -800, -800, 0, 0, 0, 0);
        ...
        EncodersControl(0.8, 1400, 1400, 1400, 1400, 0, 0, -800, -800);
        ...
        EncodersControl(1,-200,200,200, -200,0,0,0,0);
